...
// adding new buttons
$('.tabbed-overview__copy').after('<input type="button" class="catteg" id="getStronger" value="Get Stronger"/><input type="button" class="catteg" id="getLeaner"value="Get Leaner"/><input type="button" class="catteg" id="getFaster" value="Get Faster"/>');
...
$(".class-list__item:nth-child(2), .class-list__item:nth-child(3), .class-list__item:nth-child(5),.class-list__item:nth-child(6), .class-list__item:nth-child(7), .class-list__item:nth-child(8), .class-list__item:nth-child(8), .class-list__item:nth-child(10), .class-list__item:nth-child(11)").addClass("getLeaner");
